...
* 有預設的全站 og:image，但單篇文章可以單獨指定 og:image (範例: [使用預設]({% post_url 2014-12-10-resolve-sublime-text-3-erb-conflicting-end-tab-trigger %})、[自訂]({% post_url 2015-01-06-effective-life-book-is-on-the-market-now %}))
* 首頁與 RSS feed 分中英兩組、Layout 可雙語切換、部分文章可雙語切換 ([範例]({% post_url 2013-09-20-disable-itunes-starts-by-media-key %}))
