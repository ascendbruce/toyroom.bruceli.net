...
---
之前準備在 [Rails Pacific](http://railspacific.com/) 上帶的 [Refactoring workshop]({% link tw/_posts/2014-10-01-refactoring-workshop-supplement-rails-pacific-2014.md %}) 時，想到以前參加 conference 時 wifi 通常都很不穩，因此有先想一下斷網備案。
