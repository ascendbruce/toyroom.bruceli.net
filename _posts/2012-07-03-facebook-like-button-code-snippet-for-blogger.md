...
![](/images/world.png) English version: [Facebook like button code snippet for Google Blogger (iframe, 3 different style)]({% link _posts/2012-07-04-facebook-like-button-code-snippet-for-blogger.md %})
