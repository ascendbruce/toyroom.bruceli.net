...
---
接續 [Rails 打基礎 - Rails Guides 3.2.13 閱讀筆記 Part 1]({% link tw/_posts/2013-09-23-rails-guides-reading-notes-first-4-chapters.md %})
...
但如果只是要檢查是否存在，沒有更多的動作的話，`.exists?` 會比 `.any?` 理想，請參考 [閱讀筆記 part 1]({% link tw/_posts/2013-09-23-rails-guides-reading-notes-first-4-chapters.md %})
