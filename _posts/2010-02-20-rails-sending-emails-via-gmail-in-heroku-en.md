...
![](/images/world.png) 正體中文版: [Rails sending emails via gmail not working in heroku server but ok in localhost]({% link tw/_posts/2010-02-20-rails-sending-emails-via-gmail-in-heroku.md %})
